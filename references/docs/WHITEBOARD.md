...
Photos of the original planning whiteboard, plus a few cleaned-up digital diagrams, in `../whiteboard/`. They show how Drip was designed before it was built and are kept as-is for context, not maintained. Where a drawing disagrees with the docs, the docs are correct.
...
- `../whiteboard/prototypes.jpg` — The prototype checklist used to de-risk the build. The surviving prototype lives in [`references/sandbox-prototypes/`](../sandbox-prototypes/).
