...
Use this file as your operating rules and `references/docs/` as the directory map — the Documentation map in `README.md` and `references/docs/README.md` lists every doc.

## Project Map
- `references/docs/PRD.md` — product definition.
- `references/docs/BACKEND.md` — backend system map.
- `references/docs/specs/` — the four teammate specs, numbered in pipeline order (Scout, Fashion Designer, Builder, Performance Marketer).
- `references/docs/SANDBOX.md` — sandbox execution layer and base snapshot flow.
- `references/docs/CONVEX.md` — Convex-specific project rules.
- `references/docs/VERCEL.md` — Vercel-specific project rules.
- `references/docs/DEVELOPMENT.md` — local setup, localhost testing, parallel worktrees.
- `references/docs/DEPLOYMENT.md` — production deploy and verification.
- `references/docs/WHITEBOARD.md` — whiteboard notes.
- `references/` — umbrella for the docs above plus design assets (`whiteboard/`, `uimocks/`, `slides/`) and read-only external checkouts (`codex-sdk/`, `sandbox-prototypes/`).
- `agent/codex-agent/` — the agent skills and subagents that run inside the sandbox.
...
- Read `references/docs/DEVELOPMENT.md` before local setup, localhost testing, or parallel worktree work.
- Read `references/docs/DEPLOYMENT.md` before production deploy or production verification work.
...
- Convex and production verification workflows live in `references/docs/CONVEX.md` and `references/docs/DEPLOYMENT.md`.
...
- Read `references/docs/CONVEX.md` for Convex-specific project rules.
- Read `references/docs/DEVELOPMENT.md` for local workflow and `references/docs/DEPLOYMENT.md` for production workflow.
...
- Read `references/docs/VERCEL.md` for Vercel-specific project rules.
- Read `references/docs/DEPLOYMENT.md` before production deploy or production verification work.
